...
public class ArticleListActivity extends AppCompatActivity implements
    ...
    public static final String TRANSITION_POSITION_START = "start_transition";
    public static final String TRANSITION_POSITION_FINISH = "finish_transition";
    ...
    private final SharedElementCallback mCallback = new SharedElementCallback() {
        ...
        public void onMapSharedElements(List<String> names, Map<String, View> sharedElements) {
            if (mTmpReturnState != null) {
                int prePosition = mTmpReturnState.getInt(TRANSITION_POSITION_START);
                int postPosition = mTmpReturnState.getInt(TRANSITION_POSITION_FINISH);
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra(TRANSITION_POSITION_START, mPosition);
